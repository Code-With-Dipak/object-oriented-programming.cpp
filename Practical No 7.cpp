...
be the names of states
and the values will be the populations of the states. When the program
runs, the user is prompted to type the name of a state.
...
Process exited after 17.02 seconds with return value 0
